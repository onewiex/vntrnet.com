...
}
{
  ...
  (function ($) {
    ...
    function gpc(node) {
      for (
        ;
        node && node.nodeName.toLowerCase() != 'html';
        node = node.parentNode
      ) {
        var v = $.css(node, 'backgroundColor');
        if (v == 'rgba(0, 0, 0, 0)') continue; // webkit
        if (v.indexOf('rgb') >= 0) {
          var rgb = v.match(/\d+/g);
    ...
    $.fn.corner = function (options) {
      ...
      return this.each(function (index) {
        ...
        var re =
          /round|bevel|notch|bite|cool|sharp|slide|jut|curl|tear|fray|wicked|sculpt|long|dog3|dog2|dog/;
        ...
        for (var j in edges) {
          ...
          if ((bot && (opts.BL || opts.BR)) || (!bot && (opts.TL || opts.TR))) {
            ...
            if (bot && cssHeight != 'auto') {
              ...
              if (expr) {
                var bw =
                  sz(this, 'borderLeftWidth') + sz(this, 'borderRightWidth');
                ds.setExpression(
                  'width',
...
/*
     FILE ARCHIVED ON 09:40:22 Dec 28, 2014 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 14:21:08 Oct 06, 2023.
...
playback timings (ms):
  ...
  cdx.remote: 0.055
  esindex: 0.008
  LoadShardBlock: 159.443 (3)
  PetaboxLoader3.datanode: 167.306 (4)
  load_resource: 80.235
  PetaboxLoader3.resolve: 44.949
*/
